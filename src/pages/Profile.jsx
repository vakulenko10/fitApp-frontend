...
const Profile = () => {
  ...
  return (
    <>
      <div className='bg-white shadow-lg flex flex-col rounded-lg mx-12 sm:max-lg:mx-7.5 lg:mx-[7.25rem] my-8 sm:max-lg:my-14 py-4 sm:pt-4 sm:pb-7 lg:pt-6 lg:pb-[6.25] px-2 sm:px-6'>
        <h1 className='font-semibold text-lg lg:text-4xl flex justify-center sm:justify-start mb-4'>
          Account Settings
        </h1>
        <div>
          <p className='font-semibold text-center text-muted-darker text-lg lg:text-xl lg:text-xl'>
            First name
          </p>
          <Input 
            type="text"
        ...
        <div className='flex space-x-2.5 justify-center mx-3'>
          <Button className="bg-muted-darker py-3 px-6">
            Cancel
          </Button>
          <Button className="bg-ring py-3 px-6">
            Save
          </Button>
        </div>
      </div>
