...
const ProfileData = () => {
  ...
  return (
    <main className="bg-primary relative flex flex-col rounded-lg p-4 shadow-lg md:flex-row">
      <section className="order-2 flex-9/12">
      ...
      <section className="order-1 flex flex-1 items-center justify-center md:order-2">
